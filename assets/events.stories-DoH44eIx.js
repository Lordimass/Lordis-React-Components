import{j as e}from"./iframe-C2wc1zSf.js";import{a as t}from"./blocks-CNQLComZ.js";import"./preload-helper-PPVm8Dsz.js";const i=`# trackPageView() \`<Function>\`

> **trackPageView**(\`page_title?\`, \`page_location?\`): \`void\`

Defined in: [src/lib/ga/events.ts:31](https://github.com/Lordimass/Lordis-React-Components/blob/8828fcffb3798b2ea9ea82cf90efa4e89bffa01c/src/lib/ga/events.ts#L31)
...
Defined in: [src/lib/ga/events.ts:45](https://github.com/Lordimass/Lordis-React-Components/blob/8828fcffb3798b2ea9ea82cf90efa4e89bffa01c/src/lib/ga/events.ts#L45)
...
\`\`\`
`,a=`# trackJoinGroup() \`<Function>\`

> **trackJoinGroup**(\`group_id?\`): \`void\`

Defined in: [src/lib/ga/events.ts:58](https://github.com/Lordimass/Lordis-React-Components/blob/8828fcffb3798b2ea9ea82cf90efa4e89bffa01c/src/lib/ga/events.ts#L58)
...
\`void\`
`,s=`# trackLogin() \`<Function>\`

> **trackLogin**(\`method?\`): \`void\`

Defined in: [src/lib/ga/events.ts:67](https://github.com/Lordimass/Lordis-React-Components/blob/8828fcffb3798b2ea9ea82cf90efa4e89bffa01c/src/lib/ga/events.ts#L67)
...
\`void\`
`,o=`# trackSearch() \`<Function>\`

> **trackSearch**(\`search_term?\`): \`void\`

Defined in: [src/lib/ga/events.ts:78](https://github.com/Lordimass/Lordis-React-Components/blob/8828fcffb3798b2ea9ea82cf90efa4e89bffa01c/src/lib/ga/events.ts#L78)
...
Defined in: [src/lib/ga/events.ts:90](https://github.com/Lordimass/Lordis-React-Components/blob/8828fcffb3798b2ea9ea82cf90efa4e89bffa01c/src/lib/ga/events.ts#L90)
...
\`void\`
`,h='# trackSpendVirtualCurrency() `<Function>`\n\n> **trackSpendVirtualCurrency**(`value`, `virtual_currency_name`, `item_name?`): `void`\n\nDefined in: [src/lib/ga/events.ts:127](https://github.com/Lordimass/Lordis-React-Components/blob/8828fcffb3798b2ea9ea82cf90efa4e89bffa01c/src/lib/ga/events.ts#L127)\n\nThis event measures the sale of virtual goods in your app and helps you identify which virtual goods are the most\npopular.\n\n## Parameters\n\n| Parameter | Type | Description |\n| ------ | ------ | ------ |\n| `value` | `number` | The value of the virtual currency. |\n| `virtual_currency_name` | `string` | The name of the virtual currency. |\n| `item_name?` | `string` | The name of the item the virtual currency is being used for. |\n\n## Returns\n\n`void`\n\n## Example\n\n```ts\ntrackSpendVirtualCurrency(5, "Gems", "Starter Boost")\n```\n',d=`# trackTutorialBegin() \`<Function>\`

> **trackTutorialBegin**(): \`void\`

Defined in: [src/lib/ga/events.ts:143](https://github.com/Lordimass/Lordis-React-Components/blob/8828fcffb3798b2ea9ea82cf90efa4e89bffa01c/src/lib/ga/events.ts#L143)
...
Defined in: [src/lib/ga/events.ts:151](https://github.com/Lordimass/Lordis-React-Components/blob/8828fcffb3798b2ea9ea82cf90efa4e89bffa01c/src/lib/ga/events.ts#L151)
