import{n as e,o as t}from"./chunk-zsgVPwQN.js";import{F as n,b as r,c as i,m as a,n as o,rt as s,s as c,t as l}from"./iframe-p6oOQHW_.js";import{d as u,f as d,i as f,l as p,p as m,r as h,s as g,u as _}from"./blocks-CkwIrgM7.js";var v,y=e((()=>{v='# IToast `<Interface>`\n\nDefined in: [toasts.ts:7](https://github.com/Lordimass/Lordis-React-Components/blob/4148de20940979b0c6c4522a8a45b7fe497c76e5/src/lib/toasts.ts#L7)\n\nA custom toast.\n\n## Properties\n\n| Property | Type | Description |\n| ------ | ------ | ------ |\n| <a id="duration"></a> `duration?` | `number` \\| `null` | Override the time to display the toast for in seconds. Null for infinite |\n| <a id="image"></a> `image?` | [`MinimalImage`](../types/image/MinimalImage.md) | The URI of an image icon to display on the toast |\n| <a id="msg"></a> `msg` | `string` | Message to display on the toast |\n| <a id="title"></a> `title?` | `string` | Override the contents of the title of the toast. |\n| <a id="variant"></a> `variant?` | `Variant` | The variant of toast to display |\n'})),b,x=e((()=>{b="# ToastContext `<Variable>`\n\n> `const` **ToastContext**: `Context`&lt;\\{ `toast`: (`toast`) => `void`; \\}&gt;\n\nDefined in: [toasts.ts:24](https://github.com/Lordimass/Lordis-React-Components/blob/4148de20940979b0c6c4522a8a45b7fe497c76e5/src/lib/toasts.ts#L24)\n\nContext provided by ToastWrapper. Contains a single `toast` method which can be called with an instance of\n[IToast](IToast.md) to display a toast on the screen.\n"}));function S(){let{toast:e}=(0,C.useContext)(r);return(0,w.jsxs)(`div`,{style:{position:`relative`,left:`150%`,display:`flex`,flexDirection:`column`,gap:`5px`,margin:`10px`},children:[(0,w.jsx)(`button`,{className:`btn btn-primary`,onClick:()=>e({msg:`I'm a toast!`}),children:`Add Toast`}),(0,w.jsx)(`button`,{className:`btn btn-primary`,onClick:()=>e({msg:`I'm a toast that doesn't close itself!`,duration:null}),children:`Add Permanent Toast`}),(0,w.jsx)(`button`,{className:`btn btn-primary`,onClick:()=>e({msg:`I'm a toast that closes itself very fast!`,duration:.05}),children:`Add Fast Toast`})]})}var C,w,T,E,D,O,k;e((()=>{y(),x(),i(),C=t(s(),1),a(),l(),m(),w=n(),{expect:T,fn:E}=__STORYBOOK_MODULE_TEST__,D={component:c,args:{children:(0,w.jsx)(S,{}),onChange:E()},argTypes:{children:{table:{disable:!0}},defaults:{control:`object`},onChange:{control:!1,table:{defaultValue:{summary:`fn()`}}}},decorators:[e=>(0,w.jsx)(w.Fragment,{children:(0,w.jsx)(e,{})})],tags:[`skip-visual-test`],parameters:{docs:{page:()=>(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(d,{}),(0,w.jsx)(u,{}),(0,w.jsx)(f,{}),(0,w.jsx)(p,{}),(0,w.jsx)(h,{}),(0,w.jsx)(g,{children:v}),(0,w.jsx)(`br`,{}),(0,w.jsx)(g,{children:b}),(0,w.jsx)(_,{})]})}}},O={play:async({args:e,canvas:t,step:n,userEvent:r})=>{let i=t.getByText(`Add Permanent Toast`);await T(i).toBeInTheDocument();let a=t.getByText(`Add Fast Toast`);await T(a).toBeInTheDocument();let s=t.getByText(`Add Toast`);await T(s).toBeInTheDocument(),await n(`Check that the toast opens`,async()=>{await r.click(i),await T(e.onChange).toHaveBeenCalledWith(T.toSatisfy(e=>e.length==1))}),await n(`Check that the toast closes`,async()=>{let n=t.getByRole(`alert`).getElementsByClassName(`btn-close`)[0];await r.click(n),await T(e.onChange).toHaveBeenCalledWith(T.toSatisfy(e=>e[0].show==0)),await o(500),await T(e.onChange).toHaveBeenCalledWith([])}),await n(`Check that toasts will automatically close`,async()=>{await r.click(a),await T(e.onChange).toHaveBeenCalledWith(T.toSatisfy(e=>e.length==1)),await o(550),await T(e.onChange).toHaveBeenCalledWith([])}),await n(`Check opening a toast for an indeterminate length of time`,async()=>{await r.click(s),await T(e.onChange).toHaveBeenCalledWith(T.toSatisfy(e=>e.length==1))})}},O.parameters={...O.parameters,docs:{...O.parameters?.docs,source:{originalSource:`{
  play: async ({
    args,
    canvas,
    step,
